...
exports.getSpecs = exports.getMarketVal = exports.getHistory = exports.getImages = void 0;
...
var getMarketVal = function (vin) {
    ...
    return _fetch(URI).then(function (data) {
        return data.json();
    }).then(function (data) {
        return data;
    });
...
var getSpecs = function (vin) {
    var URI = BASE_URI + ("/specs?key=" + API_KEY + "&vin=" + vin + "&format=json");
    return _fetch(URI).then(function (data) {
        return data.json();
    }).then(function (data) {
        return data;
